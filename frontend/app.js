    ...
    main.innerHTML = `
      <div class="space-y-6">
        <div class="glass-panel p-4 rounded-3xl border flex flex-wrap items-center justify-between gap-4">
          ...
          <div class="flex items-center gap-2">
            <a href="#/" class="px-3 py-2 rounded-xl glass-card text-slate-300 text-xs font-bold transition flex items-center gap-1.5">
              <i data-lucide="eye" class="w-3.5 h-3.5"></i> Public Site
            </a>
            <button onclick="app.adminLogout()" class="px-3 py-2 rounded-xl bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/30 text-xs font-bold transition flex items-center gap-1.5">
          ...
          <form onsubmit="app.submitResultDeclaration(event)" class="space-y-5 text-left">
            ...
            <div class="p-4 rounded-2xl bg-amber-500/15 border border-amber-500/40 space-y-2">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-4 gap-2.5">
                <div>
                  ...
                  <input id="w1Chest" type="text" placeholder="e.g. 101" onblur="app.lookupStudent(this.value, 'w1')" class="w-full p-2 rounded-xl glass-input text-xs font-mono font-bold" required>
                </div>
                <div>
                  <label class="text-[10px] text-slate-400 uppercase font-bold">Name</label>
                  <input id="w1Name" type="text" placeholder="Auto-filled" class="w-full p-2 rounded-xl glass-input text-xs font-bold">
                </div>
                <div>
                  <label class="text-[10px] text-slate-400 uppercase font-bold">House</label>
                  <select id="w1House" class="w-full p-2 rounded-xl glass-input text-xs bg-slate-900 font-bold">
                    ${this.state.houses.map(h => `<option value="${h.id}">${h.name}</option>`).join('')}
                  </select>
                </div>
            ...
            <div class="p-4 rounded-2xl bg-slate-800/40 border border-slate-700/60 space-y-2">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-4 gap-2.5">
                <div>
                  <label class="text-[10px] text-slate-400 uppercase font-bold">Chest No</label>
                  <input id="w2Chest" type="text" placeholder="e.g. 102" onblur="app.lookupStudent(this.value, 'w2')" class="w-full p-2 rounded-xl glass-input text-xs font-mono font-bold">
                </div>
                <div>
                  <label class="text-[10px] text-slate-400 uppercase font-bold">Name</label>
                  <input id="w2Name" type="text" placeholder="Auto-filled" class="w-full p-2 rounded-xl glass-input text-xs font-bold">
                </div>
                <div>
                  <label class="text-[10px] text-slate-400 uppercase font-bold">House</label>
                  <select id="w2House" class="w-full p-2 rounded-xl glass-input text-xs bg-slate-900 font-bold">
                    ${this.state.houses.map(h => `<option value="${h.id}">${h.name}</option>`).join('')}
                  </select>
                </div>
                <div class="grid grid-cols-2 gap-1.5">
            ...
            <div class="p-4 rounded-2xl bg-amber-950/20 border border-amber-800/40 space-y-2">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-4 gap-2.5">
                <div>
                  <label class="text-[10px] text-slate-400 uppercase font-bold">Chest No</label>
                  <input id="w3Chest" type="text" placeholder="e.g. 103" onblur="app.lookupStudent(this.value, 'w3')" class="w-full p-2 rounded-xl glass-input text-xs font-mono font-bold">
                </div>
                <div>
                  <label class="text-[10px] text-slate-400 uppercase font-bold">Name</label>
                  <input id="w3Name" type="text" placeholder="Auto-filled" class="w-full p-2 rounded-xl glass-input text-xs font-bold">
                </div>
                <div>
                  <label class="text-[10px] text-slate-400 uppercase font-bold">House</label>
                  <select id="w3House" class="w-full p-2 rounded-xl glass-input text-xs bg-slate-900 font-bold">
                    ${this.state.houses.map(h => `<option value="${h.id}">${h.name}</option>`).join('')}
                  </select>
                </div>
                <div class="grid grid-cols-2 gap-1.5">
            ...
            <div class="flex justify-end pt-2">
              <button type="submit" class="px-6 py-3.5 bg-gradient-to-r from-amber-500 to-indigo-600 hover:from-amber-400 hover:to-indigo-500 text-white font-black text-sm rounded-2xl shadow-xl transition flex items-center gap-2">
